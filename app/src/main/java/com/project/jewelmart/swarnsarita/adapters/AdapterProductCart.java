...
public class AdapterProductCart extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterProductCart(Context context, List<Cart.Datum> items) {
        this.items = items;
        ctx = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_layout_cart, parent,
                false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            view2.image.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    private void onMoreButtonClick(final View view, final Cart.Datum p, final int position) {
        ...
        popupMenu.inflate(R.menu.menu_cart_more);
        popupMenu.show();
    }
        ...
        countriesCall.enqueue(new Callback<Acknowledge>() {
            ...
            public void onResponse(Call<Acknowledge> call, Response<Acknowledge> response) {
                ...
                if (resource.getAck().equals("1")) {
                    ...
                    removeAt(position);
                    SplashActivity.getCartCount(ctx, new UserSessionManager(ctx).getUserID(), "cart");
                } else {
                    Toast.makeText(ctx, resource.getMsg(), Toast.LENGTH_SHORT).show();
                }
            }
