...
//
public class CustomStockCatRecycleAdapter extends RecyclerView.Adapter<CustomStockCatRecycleAdapter.ViewHolder> {

    Context context;
    private final List<Collection> orderList;

    String todaysDate = "";

    public CustomStockCatRecycleAdapter(Context context, ArrayList<Collection> catalogueList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View v, ArrayList<Collection> orderList) {
            super(v);
        ...
        public void onClick(View view) {
            ...
            if (subcat > 0) {
                ...
                args.putString("table", "inventory_master");
                ...
                intent.putExtra("table", "inventory_master");
                context.startActivity(intent);
