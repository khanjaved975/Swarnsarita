...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    private List<com.project.jewelmart.swarnsarita.adapters.App> mApps;
    private boolean mHorizontal;
    private boolean mPager;

    public Adapter(boolean horizontal, boolean pager, List<com.project.jewelmart.swarnsarita.adapters.App> apps) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (mPager) {
            return new ViewHolder(LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_call_email, parent, false));
        } else {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        com.project.jewelmart.swarnsarita.adapters.App app = mApps.get(position);
