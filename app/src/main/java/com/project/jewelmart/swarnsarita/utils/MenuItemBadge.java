...
//    }
    ...
    public static void update(final Activity activity, final MenuItem menu, MenuItemBadge.Builder builder, final ActionItemBadgeListener listener) {
        ...
        badgeTextView = (MaterialBadgeTextView) badge.findViewById(R.id.menu_badge2);
        ...
        if(imageView != null && builder != null){
            if (builder.iconDrawable !=null) {
                ...
                Drawable d=builder.iconDrawable;
                /*Glide.with(activity).load(R.drawable.ic_action_delete)
                        .crossFade()
                        .into(imageView);  */          }
    ...
    public static MaterialBadgeTextView getBadgeTextView(MenuItem menu) {
        ...
        MaterialBadgeTextView badgeView = (MaterialBadgeTextView) badge.findViewById(R.id.menu_badge2);
        return badgeView;
    }
