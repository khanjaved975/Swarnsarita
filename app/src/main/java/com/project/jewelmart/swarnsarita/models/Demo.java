...
public final class Demo {
    ...
    public static String[] getDescriptions() {
        return new String[]{
                ...
                "Daniel Morales - the fastest delivery man for the local pizza parlor Pizza Joe in Marseille, France. On the last day of work, he sets a badgenew speed record, then leaves the job to pursue a badgenew career as a taxi driver with the blessings of his boss and co-workers. Daniel's vehicle is a white 1997 Peugeot 406..."
        };
    }

    public static List<com.project.jewelmart.swarnsarita.models.CustomImage> getCustomImages() {
        String[] posters = getPosters();
        String[] descriptions = getDescriptions();
        List<com.project.jewelmart.swarnsarita.models.CustomImage> images = new ArrayList<>();

        for (int i = 0; i < posters.length; i++) {
            images.add(new com.project.jewelmart.swarnsarita.models.CustomImage(posters[i], descriptions[i]));
        }
