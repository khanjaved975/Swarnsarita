...
public class AdapterNotificationList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<NotificationModel.Datum> items = new ArrayList<>();
    ...
    public AdapterNotificationList(Context context, List<NotificationModel.Datum> items, int animation_type) {
        this.items = items;
        ctx = context;
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        ...
        public FontTextView  msg, orderid, date;
        public FontBoldTextView title;
        public View lyt_parent;

        public OriginalViewHolder(View v) {
            super(v);
            image_count = (ImageView) v.findViewById(R.id.image_count);
            orderid = (FontTextView) v.findViewById(R.id.prod_id);
            title = (FontBoldTextView) v.findViewById(R.id.title);
            msg = (FontTextView) v.findViewById(R.id.msg);
            date = (FontTextView) v.findViewById(R.id.date);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof OriginalViewHolder) {
            ...
            view.title.setText("Title : " + p.getTitle());
            view.msg.setText("Message : " + p.getSubTitle());
            view.date.setText("Date : " + p.getCreated());
            Tools.displayImageOriginal(ctx, view.image_count, p.getImageName(),
                    "public/backend/product_images/zoom_image/");
