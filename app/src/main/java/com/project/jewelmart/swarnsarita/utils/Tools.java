...
public class Tools {
    ...
    public static void showCustomDialog(Context context, String t, String msg) {
    ...
    public static void showDialogLogout(final Activity context, String t, String msg) {
        ...
        lp.width = WindowManager.LayoutParams.WRAP_CONTENT;
        lp.height = WindowManager.LayoutParams.WRAP_CONTENT;
        ((AppCompatButton) dialog.findViewById(R.id.bt_close)).setText("Continue");
        ((AppCompatButton) dialog.findViewById(R.id.bt_close)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public static void displayImageOriginal(Context ctx, ImageView img, String url, String path) {
        try {//public/backend/product_images/zoom_image/
            Glide.with(ctx).load(com.project.jewelmart.swarnsarita.utils.Constant.Url + path + url)
   ...
   /* public static GoogleMap configActivityMaps(GoogleMap googleMap) {
    ...
    public static void scrollTo(final ScrollView nested, final View targetView) {
        nested.post(new Runnable() {
            @Override
            public void run() {
                nested.scrollTo(500, targetView.getBottom());
    ...
    public static String getdayscount(String Created_date_String, String Expire_date_String) {
        // SimpleDateFormat dateFormat = new2 SimpleDateFormat("dd/MM/yyyy", Locale.getDefault());

        String dateStart = Created_date_String;
        String dateStop = Expire_date_String;
